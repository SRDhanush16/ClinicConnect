...
public class JwtService {
    ...
    public boolean isValidDoctor(String token, UserDetails user) {
        String username = extractUsername(token);

        boolean validToken = tokenDoctorsRepository
                .findByToken(token)
    ...
    public String generateTokenforDoctor(Doctors doctor) {

        String token = Jwts
                .builder()
                .subject(doctor.getUsername()) // add claim
